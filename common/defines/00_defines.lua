...
NGame = {
	START_DATE = "2022.10.12.12",
	END_DATE = "2100.12.31.23",
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "2022.10.12.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 12,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
...
NAir = {
	...
	ACCIDENT_EFFECT_MULT = 0.01,						-- Multiplier for balancing the effect of accidents
